...
@EndUserText.label: 'Approval Projection view'
...
define root view entity ZC_Travel_Approver_860_m
  ...
  as projection on ZI_TRAVEL_860_M
{
  ...
  key TravelId,
      ...
      /* Associations */
      _Agency,
      _Booking : redirected to composition child ZC_Booking_Approval_860_M,
      _Currency,
      _Customer,
      _Status
}
