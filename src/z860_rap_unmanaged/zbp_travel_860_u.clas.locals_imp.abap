CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    TYPES: tt_booking_failed   TYPE TABLE FOR FAILED zI_Booking_860_U,
           tt_booking_reported TYPE TABLE FOR REPORTED zI_Booking_860_U.
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_features.
    ...
    READ ENTITIES OF ZI_TRAVEL_860_u IN LOCAL MODE
    ENTITY Travel
    ...
    result = VALUE #( FOR travel_read_result IN travel_read_results ( %tky = travel_read_result-%tky
...
*         et_booking_supplement =
      ...
      ELSE.
        ...
        "set the last booking id to the highest value of booking_old booking_id or initial value if none exist
        ...
        LOOP AT <travel>-%target ASSIGNING FIELD-SYMBOL(<booking_create>).
          ...
          CALL FUNCTION '/DMO/FLIGHT_TRAVEL_UPDATE'
            EXPORTING
              ...
              it_bookingx = VALUE /dmo/t_booking_inx( ( booking_id = booking-booking_id
