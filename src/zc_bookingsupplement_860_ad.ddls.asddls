...
define view entity ZC_BookingSupplement_860_AD
  as projection on Zi_BookingSupplement_860_Dr
{
  key BookSupplUUID,
      ...
      /* Associations */
      _Booking : redirected to parent ZC_Booking_860_AD,
      _Product,
      _SupplementText,
      _Travel  : redirected to ZC_TRAVEL_860_AD
}
