...
define view entity ZC_Booking_860_AD
  as projection on Zi_BOOKING_860_dr
{
  key BookingUUID,
...
//        ]
     @Consumption.valueHelpDefinition: [ {entity: {name: '/DMO/I_Flight', element: 'ConnectionID'},
      ...
      /* Associations */
      _BookingSupplement : redirected to composition child ZC_BookingSupplement_860_AD,
      _BookingStatus,
      _Carrier,
      _Connection,
      _Customer,
      _Travel            : redirected to parent ZC_TRAVEL_860_AD
}
